...
# Date (last modified/checked): 07/11/2024
...
# Creating non-date-specific input file names
...
for date in list_of_dates
    for i in eachindex(bias_vec)
        ...
        reposition_df = load(input_dir * "Repositioning Files/" * month * "-" * year * "_top_5_CAs_by_hour_no_AP.jld2","reposition_df")
